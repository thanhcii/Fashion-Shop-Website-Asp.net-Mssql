<%@ Page Language="C#" MasterPageFile="~/UserControl/NguoiDung.master" AutoEventWireup="true" CodeFile="Quanjeannu.aspx.cs" Inherits="GiaoDien_Quanjeannu" %>
...
<asp:DataList ID="dlQuanjeannu" runat="server" RepeatColumns="4" 
                RepeatDirection="Horizontal" Width="551px" 
        onitemcommand="dlQuanjeannu_ItemCommand">
                <ItemTemplate>
                    <table>
