<%@ Page Language="C#" MasterPageFile="~/UserControl/NguoiDung.master" AutoEventWireup="true" CodeFile="Aosominu.aspx.cs" Inherits="GiaoDien_Aosominu" %>
...
<div class="slideshow">
   ...
   <asp:DataList ID="dlAosominu" runat="server" RepeatColumns="4" 
                RepeatDirection="Horizontal" Width="551px" 
           onitemcommand="dlAosominu_ItemCommand" 
           onselectedindexchanged="dlAosominu_SelectedIndexChanged">
                <ItemTemplate>
                    <table>
