<%@ Page Language="C#" MasterPageFile="~/UserControl/NguoiDung.master" AutoEventWireup="true" CodeFile="Quanjeannam.aspx.cs" Inherits="GiaoDien_Quanjeannam" %>
...
<asp:DataList ID="dlQuanjeannam" runat="server" RepeatColumns="4" 
                RepeatDirection="Horizontal" Width="551px" 
        onitemcommand="dlQuanjeannam_ItemCommand">
                <ItemTemplate>
                    <table>
