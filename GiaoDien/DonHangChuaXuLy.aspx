<%@ Page Language="C#" MasterPageFile="~/UserControl/Admin.master" AutoEventWireup="true" CodeFile="DonHangChuaXuLy.aspx.cs" Inherits="GiaoDien_QuanLyDonHang" Title="Untitled Page" %>
...
<asp:Repeater ID="rptDonHang" runat="server" onitemcommand="rptDonHang_ItemCommand">
                    ...
                    <div style="margin:10px auto auto 100px">
                        <table>
                            <tr>
                                <td><asp:Button runat="server" ID="btXuLy" Text="Xử lý thành công" 
                                        onclick="btXuLy_Click" /></td>
                                <td><asp:Button runat="server" ID="btnCap" Text="Không xử lý đơn hàng" 
                                        onclick="btnCap_Click" /></td>
                            </tr>
                        </table>
                    </div>
</div>
