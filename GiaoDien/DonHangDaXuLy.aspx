<%@ Page Language="C#" MasterPageFile="~/UserControl/Admin.master" AutoEventWireup="true" CodeFile="DonHangDaXuLy.aspx.cs" Inherits="GiaoDien_DonHangDaXuLy" Title="Untitled Page" %>
...
<div>
    ...
    <div>
        <asp:Repeater ID="rptDonHang" runat="server" 
            onitemcommand="rptDonHang_ItemCommand">
                        <HeaderTemplate>
                        ...
                        <table>
                            <tr>
                                <td><asp:Button runat="server" ID="btBack" Text="Trở về trang cũ" onclick="btBack_Click" 
                                         /></td>
                                <td><asp:Button runat="server" ID="btnIn" Text="In đơn hàng" 
