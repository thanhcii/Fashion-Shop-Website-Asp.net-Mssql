<%@ Page Language="C#" MasterPageFile="~/UserControl/NguoiDung.master" AutoEventWireup="true" CodeFile="Aosominam.aspx.cs" Inherits="GiaoDien_Aosominam" %>
...
<asp:DataList ID="dlAosominam" runat="server" RepeatColumns="4" 
                RepeatDirection="Horizontal" Width="551px" 
        onitemcommand="dlAosominam_ItemCommand">
                <ItemTemplate>
                    <table>
