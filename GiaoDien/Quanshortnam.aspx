<%@ Page Language="C#" MasterPageFile="~/UserControl/NguoiDung.master" AutoEventWireup="true" CodeFile="Quanshortnam.aspx.cs" Inherits="GiaoDien_Quanshortnam" %>
...
<asp:DataList ID="dlQuanshortnam" runat="server" RepeatColumns="4" 
                RepeatDirection="Horizontal" Width="551px" 
        onitemcommand="dlQuanshortnam_ItemCommand">
                <ItemTemplate>
                    <table>
