<%@ Page Language="C#" MasterPageFile="~/UserControl/NguoiDung.master" AutoEventWireup="true" CodeFile="Aophongnam.aspx.cs" Inherits="GiaoDien_Aophongnam" %>
...
<asp:DataList ID="dlAophongnam" runat="server" RepeatColumns="4" 
                RepeatDirection="Horizontal" Width="551px" 
        onitemcommand="dlAophongnam_ItemCommand">
                <ItemTemplate>
                    <table>
